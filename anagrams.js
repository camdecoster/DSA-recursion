...
// create the new words. For example, given "east", use "e" as a prefix and place
// it in front of all 6 permutations of "ast" — "ast", "ats", "sat", "sta", "tas",
// and "tsa". This will give you the words "east", "eats", "esat", "esta", "etas",
// and "etsa". Continue this way until you find all the anagrams for "east". Then
// you can use "a" as a prefix and permute the remaining words "est". For "east",
...
function anagrams(word) {
    ...
    for (let i = 0; i < word.length; i++) {
        ...
        const newWords = anagrams(word.slice(1));
        for (let j = 0; j < newWords.length; j++) {
            words.push(firstLetter + newWords[j]);
        }
        // Shift first letter to end
